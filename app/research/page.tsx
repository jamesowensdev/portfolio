          ...
          >
            <div className="bg-black/10 backdrop-blur-md border border-white/10 rounded-sm p-6 md:p-8 shadow-2xl prose prose-invert max-w-none">
              <p className="text-lg md:text-xl leading-relaxed text-yellow-300 font-light mb-6">
                ...
                and assessing their efficacy across species and landscapes.
              </p>
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-8">
                ...
                simulated data, my aim is to find the breaking point at which
                the models&apos; accuracy fails when applied to real-world
                ecological data. This analysis will then act as a springboard
                for further research into developing GP models specially for
                ecological data analysis.
              </p>

              <p className="text-lg md:text-xl leading-relaxed text-indigo-400 font-light mb-0">
          ...
          >
            ...
            <div className="bg-black/10 backdrop-blur-md border border-white/10 rounded-sm p-6 md:p-8 shadow-2xl prose prose-invert max-w-none">
              ...
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-4">
                Geographic profiling is a technique developed in Criminology by
                Dr Kim Rossmo to help deal with the information overload
                associated with serial crimes. It allows law enforcement to more
                accurately focus investigation efforts by estimating a
                criminal&apos;s anchor point (home, workplace, etc.).<br></br>
                <br></br>
              ...
              <ul className="text-sm md:text-base text-white/60 leading-relaxed mb-4 space-y-4">
                <li>
                  ...
                  - Excluding other external variables, an individual will
                  choose to commit an act at the minimum distance required to
                  reach a target
                </li>
                <li>
              ...
              <p className="text-sm md:text-base text-white/60 leading-relaxed">
                Ultimately, these three principles intersect to form a
                predictive mathematical surface that transforms scattered
                incident data into a highly targeted search area.
              </p>
            </div>
          </motion.div>
          <div className="hidden md:block">
        ...
        <section className="min-h-[100dvh] w-full snap-start flex flex-col justify-start md:justify-center px-6 pt-24 pb-16 md:py-24 relative">
          ...
          >
            ...
            <div className="bg-black/10 backdrop-blur-md border border-white/10 rounded-sm p-6 md:p-8 shadow-2xl prose prose-invert max-w-none">
              ...
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-4">
                The same principles which make GP such a powerful tool for
                spatial analysis in criminology can also be applied to ecology.
                Most obviously, in the case of central place foragers (CPF).
                These CPF are species which are tethered to a specific anchor
                point to which it must return. Most commonly, these anchor
                points are the locations of roosts or nest sites, but they can
                also be linked to breeding sites and food caches.
              </p>
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-6">
                ...
                such their foraging patterns can be considered comparatively
                with Rossmo&apos;s original concepts.
              </p>
              <ul className="text-sm md:text-base text-white/60 leading-relaxed mb-4 space-y-4">
                <li>
                  <em className="text-yellow-300">
                ...
                <li>
                  <em className="text-yellow-300">Buffer Zone</em> - The area
                  immediately surrounding the anchor point has a lower
                  probability of foraging due to the avoidance alerting
                  predators as to their nest location. Particularly poignant in
                  the case of mothers with young offspring.
                </li>
                <li>
                  <em className="text-yellow-300">Decay Distance</em>- The
                  probability of foraging decreases with distance from the
                  anchor point. In an ecological context, Marginal Value Theorem
                  states that an individual must balance the energetic cost of
                  travel with the resource density of a foraging patch. In the
                  case of single-load foragers such as raptors, this dictates
                  that as distance from the nest increases, the quality of the
                  prey must increase to justify the return journey.
                </li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="bg-black/10 backdrop-blur-md border border-white/10 rounded-sm p-6 md:p-8 shadow-2xl prose prose-invert max-w-none">
              ...
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-4">
                ...
                drawn to specific habitats types to feed. Therefore, where
                current GP models may predict an anchor point may be skewed as a
                result of sighting density in favoured habitats, rather than
                considering the spatial distribution of resources in their
                priors.
              </p>
              <p className="text-sm md:text-base text-white/60 leading-relaxed">
                ...
                cost of collecting it. In order to overcome these limitations,
                and to allow us to replicate movement consistently, we are using
                an agent-based modelling approach to generate synthetic movement
          ...
          >
            ...
            <div className="bg-black/10 backdrop-blur-md border border-white/10 rounded-sm p-6 md:p-8 shadow-2xl prose prose-invert max-w-none">
              ...
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-4">
                ...
                persistence degree of the agent based on its current state we
                can change how it moves when hunting vs returning to its anchor
                point vs exploring new areas.
              </p>
              <p className="text-sm md:text-base text-white/60 leading-relaxed mb-6">
